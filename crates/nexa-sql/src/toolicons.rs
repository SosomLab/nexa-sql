...
material!(/// `visibility` — 숨김 파일 표시(눈 · 프로젝트 탐색기 필터 옆 토글 · 09-22).
    mi_visibility, "M480-320q75 0 127.5-52.5T660-500q0-75-52.5-127.5T480-680q-75 0-127.5 52.5T300-500q0 75 52.5 127.5T480-320Zm0-72q-45 0-76.5-31.5T372-500q0-45 31.5-76.5T480-608q45 0 76.5 31.5T588-500q0 45-31.5 76.5T480-392Zm0 192q-146 0-266-81.5T40-500q54-137 174-218.5T480-800q146 0 266 81.5T920-500q-54 137-174 218.5T480-200Zm0-300Zm0 220q113 0 207.5-59.5T832-500q-50-101-144.5-160.5T480-720q-113 0-207.5 59.5T128-500q50 101 144.5 160.5T480-280Z");
material!(/// 점 파일(`.name`) 표시 — 자체 그림: 작은 점 + 이름 획(Windows 전용 토글 · 09-22).
    mi_dot_file, "M200-340q-33 0-56.5-23.5T120-420q0-33 23.5-56.5T200-500q33 0 56.5 23.5T280-420q0 33-23.5 56.5T200-340Zm160-20v-80h480v80H360Zm0-160v-80h480v80H360Z");
material!(/// `folder_check`(Material Symbols) — 경로까지 검색(프로젝트 탐색기 필터 넷째 토글 · 사용자 09-22 지정 아이콘).
    mi_path_match, "m434-297 226-227-56-56-170 170-85-85-57 57 142 141ZM160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h240l80 80h320q33 0 56.5 23.5T880-640v400q0 33-23.5 56.5T800-160H160Zm0-80h640v-400H447l-80-80H160v480Zm0 0v-480 480Z");
