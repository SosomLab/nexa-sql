...
- 현 단계: **M1·M2 병행 진행(2026-09-16 · 맥 세션 종료 → Windows 이관)** — 드라이버 4종(sqlite·oracle·mssql·pg) · CLI · GUI(접속 창·탐색기·편집기·그리드·자체 파일 대화상자·스플리터) · DR-1~29 · 줄끝 정책 [38](docs/38-line-endings.md) · **글자 = Windows GDI ClearType 글리프(D-77 · `ui.text_gdi` · 검증 `scripts/win-capture.ps1`)**. **⏳ Windows 재검증 T-88 · 결정 대기 T-87 · D-51~57 · 결과 다중 탭 T-93.**
