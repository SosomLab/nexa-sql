...
| **T-136** | P1 | 중 | **편집기 입력 지연 2차**([55 §5](55-editor-input-latency.md)): D6 픽셀 버퍼 보존(softbuffer 프레임당 20 MB 할당 제거) → D5 부분 무효화(`Invalidations` 합집합·층 건너뜀) · D12 휠 뒤 60 fps 핀 해제 · D16 자동 반복 합치기 · D7 하이라이터 줄 캐시 · D9/D10 글꼴 경로·아틀라스 · 39 §6 게이트(2 MB 페인트 ≤ 20 ms) | 55 39 | ☐ |
