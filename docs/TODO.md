...
| **T-137** | P1 | 중 | **수동 커밋 잠금 방지**([56](56-manual-commit-lock-prevention.md) 📐 · D-100~D-105 결정 뒤): ① L1 읽기 트랜잭션 자동 종료(`tx.read_end`) ② L2 유휴 미커밋 경고·재알림·카운트다운 자동 롤백 ③ L3 막힘 감지(메타 세션 · 4방언) ④ L4 서버 안전망 세션 파라미터 ⑤ (2차) 접속 유형 프리셋 | 56 | 📐 |
